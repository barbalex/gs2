          ...
          <section id="blue-borders" className="projekt sektion anchor">
            ...
            <Carousel>
              ...
              <CarouselItem>
                ...
                <div className="carousel-caption">
                  <h2>Ereignisse und Statistiken</h2>
                </div>
              </CarouselItem>
              <CarouselItem>
